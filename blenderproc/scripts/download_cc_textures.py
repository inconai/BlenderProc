    ...
    while True:
        ...
        if "foundAssets" in json_data and len(json_data["foundAssets"]) > 0:
            for asset in json_data["foundAssets"]:
                if "downloadFolders" in asset and "default" in asset[
                    "downloadFolders"] and "downloadFiletypeCategories" in asset["downloadFolders"]["default"]:
            ...
            break
    excluding_list = ["sign", "roadlines", "manhole", "backdrop", "foliage", "TreeEnd", "TreeStump", "3DBread",
                      "3DApple", "FlowerSet", "FoodSteps", "PineNeedles", "Grate", "PavingEdge", "Painting",
